...
If you have downloaded the toolbox materials, the relevant folder for this tutorial is `/toolbox/`. So, we can fire up RStudio and navigate to the folder using RStudio's file navigator, and set it as the working directory by clicking More -> Set as Working Directory
